...
# プレイヤースポーン地点追加処理
from .add_player_spawnpoint import MYADDON_OT_load_spawnpoint
from .add_player_spawnpoint import MYADDON_OT_set_spawnpoint
from .add_player_spawnpoint import MYADDON_OT_spawn_create_player_symbol
from .add_player_spawnpoint import MYADDON_OT_spawn_create_enemy_symbol
# シーン出力処理
...
classes = (
    ...
    MYADDON_OT_load_spawnpoint,
    MYADDON_OT_set_spawnpoint,
